...
class DefaultController extends Controller
{
    ...
    public function createQrAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($post)
            ->add('titreQuestion', TextType::class, array('attr' => array('class' => 'form-control','name' =>'darnassus', 'style' => 'margin-top:10px;width:50%;margin-left:15px') ))
            ->add('contenuQuestion', TextareaType::class, array('attr' => array('class' => 'form-control', 'style' => 'margin-top:10px;width:50%;height:60px;margin-left:15px')))
            ->add('Save', SubmitType::class, array('label' => 'Create Post', 'attr' => array('class' => 'btn btn-primary', 'style' => 'margin-top:20px')))
            ->getForm();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('qr_create');
